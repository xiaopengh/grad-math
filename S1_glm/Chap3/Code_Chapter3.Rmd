...
<span class="probleme">📌</span> **Note**: that for $k=2$
...
<span class="solution"><span style="color: blue;">**Ⓡ**</span> </span>  
...
<span class="solution">📈</span>   The plan is complete and unbalanced
...
<span class="solution">📈</span>  The regressor `AGE` has a strong impact  and the factor `alcool`is less significant. The interaction is  not significant (`Pr(>F)`>5\%). 
